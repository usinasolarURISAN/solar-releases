...
var EpeverController = /** @class */ (function () {
    ...
    EpeverController.prototype.getGenericData = function (request, response) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        body = request.body;
                        if (!(0, utils_1.validateGetGenericDeviceDataRequestBody)(body, 'epever')) {
                            throw new utils_1.DefaultErrorPayload('VL000000');
                        }
                        dataKeys = body.dataKeys, deviceId = body.deviceId, interval_1 = body.interval;
                        return [4 /*yield*/, database_1.MainDataSource.manager.find(models_1.Epever, {
                                select: dataKeys,
                                where: {
                                    deviceId: deviceId,
                                },
                    ...
                    case 1:
                        all = _a.sent();
                        console.log("[EPEVER CONTROLLER] - Found " + all.length + " epever data for device " + deviceId);
                    ...
                    case 2:
                        ...
                        console.log("[EPEVER CONTROLLER] - Filtered " + filteredGranularity.length + " epever data for device " + deviceId);
