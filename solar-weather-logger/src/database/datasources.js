...
exports.initializeDatabases = exports.MainDataSource = void 0;
var typeorm_1 = require("typeorm");
var entitiesPath = ["./src/models/*.+(js|ts)", "./models/*.+(js|ts)"];
...
var initializeDatabases = function () { return __awaiter(void 0, void 0, void 0, function () {
    var err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                if (exports.MainDataSource.isInitialized) {
                    console.log("[DATA SOURCE] - Already initialized");
                    return [2 /*return*/];
                }
                return [4 /*yield*/, exports.MainDataSource.initialize()];
            case 2:
                _a.sent();
