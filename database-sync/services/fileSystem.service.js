...
var FileSystemService = /** @class */ (function () {
     ...
     */
    FileSystemService.prototype.fetchEpeverDataFromCSV = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
            var data, filePath;
            return __generator(this, function (_a) {
                data = [];
                filePath = path.resolve(__dirname, '..', '..', 'csv', fileName);
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        fileSystem
                            ...
                            data.push((0, utils_1.parseStringObjectToEpeverObject)(row));
                        })
