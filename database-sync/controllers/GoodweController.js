...
var GoodweController = /** @class */ (function () {
    ...
    GoodweController.prototype.getLocalData = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, datasources_1.MainDataSource.manager.find(models_1.Goodwe, defaultOptionsMainData)];
                    case 1:
                        mainData = _a.sent();
    ...
    GoodweController.prototype.fetchFirestoreData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.firestoreService.fetchDocs('goodwe')];
                    case 1:
                        data = _a.sent();
     ...
     * @returns
     */
    GoodweController.prototype.fetchCSVData = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
    ...
    GoodweController.prototype.syncData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, datasources_1.MainDataSource.manager.save(models_1.Goodwe, element)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
